...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.intro_label = Label(self, text='Gerçek Zamanlı Para Birimi Dönüştürücü', fg='white', bg='dark grey',
                                 relief=tk.RAISED, borderwidth=3)
        self.intro_label.config(font=('Courier', 15, 'bold'))

        self.date_label = Label(self, text=f" Tarih : {self.currency_converter.data['date']}", relief=tk.GROOVE,
                                borderwidth=5)
